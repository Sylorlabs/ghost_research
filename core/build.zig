...
// import it via:  const core = b.dependency("core", .{}); core.module("flame")
//
...
const core_modules = [_]CoreModule{
    ...
    .{ .name = "flame", .path = "src/flame.zig" },
    .{ .name = "flare", .path = "src/flare.zig" },
    .{ .name = "flux", .path = "src/flux.zig" },
    .{ .name = "fractal", .path = "src/fractal.zig" },
    .{ .name = "frost", .path = "src/frost.zig" },
