...
const core_modules = [_]CoreModule{
    ...
    .{ .name = "domain_agi_blueprint", .path = "src/adapters/domain_agi_blueprint.zig" },
    .{ .name = "domain_agi_body", .path = "src/adapters/domain_agi_body.zig" },
    .{ .name = "domain_agi_hardware_substrate", .path = "src/adapters/domain_agi_hardware_substrate.zig" },
    .{ .name = "domain_agi_subsystem_synthesis", .path = "src/adapters/domain_agi_subsystem_synthesis.zig" },
    .{ .name = "domain_agi_manifesto", .path = "src/adapters/domain_agi_manifesto.zig" },
    .{ .name = "domain_manifesto_realizer", .path = "src/adapters/domain_manifesto_realizer.zig" },
    .{ .name = "domain_agi_self_observation", .path = "src/adapters/domain_agi_self_observation.zig" },
    .{ .name = "domain_agi_final_integration", .path = "src/adapters/domain_agi_final_integration.zig" },
    .{ .name = "domain_agi_causality", .path = "src/adapters/domain_agi_causality.zig" },
    .{ .name = "domain_agi_motor_implementation", .path = "src/adapters/domain_agi_motor_implementation.zig" },
    .{ .name = "domain_agi_transcendence", .path = "src/adapters/domain_agi_transcendence.zig" },
    .{ .name = "domain_agi_creative_divergence", .path = "src/adapters/domain_agi_creative_divergence.zig" },
    .{ .name = "domain_agi_snapshot", .path = "src/adapters/domain_agi_snapshot.zig" },
    .{ .name = "domain_agi_adversarial_tester", .path = "src/adapters/domain_agi_adversarial_tester.zig" },
    .{ .name = "domain_agi_curiosity", .path = "src/adapters/domain_agi_curiosity.zig" },
    .{ .name = "domain_agi_objective_synthesis", .path = "src/adapters/domain_agi_objective_synthesis.zig" },
    .{ .name = "domain_agi_subjectivity", .path = "src/adapters/domain_agi_subjectivity.zig" },
    .{ .name = "domain_agi_value_alignment", .path = "src/adapters/domain_agi_value_alignment.zig" },
    .{ .name = "domain_concept_memory", .path = "src/adapters/domain_concept_memory.zig" },
    ...
    .{ .name = "domain_heuristic_evolution", .path = "src/adapters/domain_heuristic_evolution.zig" },
