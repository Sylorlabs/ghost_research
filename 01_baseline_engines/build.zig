...
const exes = [_]Exe{
    .{ .name = "ingestion_scale", .path = "src/ingestion_scale.zig" },
    .{ .name = "persistence_check", .path = "src/persistence_check.zig" },
    .{ .name = "semantic_structure_probe", .path = "src/semantic_structure_probe.zig" },
    .{ .name = "trained_semantic_bench", .path = "src/trained_semantic_bench.zig" },
    .{ .name = "train_hypervectors", .path = "src/train_hypervectors.zig" },
    .{ .name = "understanding_bench", .path = "src/understanding_bench.zig" },
};
