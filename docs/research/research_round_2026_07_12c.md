...
**Status:** LIVE — 4/6 experiments complete; J4 is a valid negative, J5 is ready, and J6 is blocked.
...
| J5 | Terra medium | Adversarial trajectory audit | Does J2/J4 survive permutation, label-availability, answer-shaped-prefix, unrelated-control, and equal-cost attacks? | ready for J1/J2/J4 inputs | Independent sampler/replay; all positive paths challenged; explicit audit verdict. | `docs/research/trajectory_audit_round_j.md`, `results/trajectory_audit_round_j.csv`, `sparse_poly_discovery/trajectory_audit_round_j.zig` |
