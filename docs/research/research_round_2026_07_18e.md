...
**Status:** PARTIALLY LANDED — AO1 and AO3 are gate-ready; AO2 is inconclusive for the old same-user boundary and supplies hostile fixtures. AO4 is ready to attack the actual hardened launcher.
