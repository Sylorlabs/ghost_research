...
**Status:** AS1/AS2 are gate-ready adapters; AS3 and AS4 are bounded local-artifact positives; AS5 is a valid negative; AS6 is now the remaining reduction audit.
