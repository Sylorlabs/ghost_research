...
| 3 | Non-human grammar | Do bulk machine-invented (non-human) atoms escape a proven family-level wall that human families can't? | pending | — | `wcore/docs/research/nonhuman_grammar.md` |
| 4 | Parallel swarm on LABS | Does a massively-parallel diverse strategy pool crack an open LABS even-N gap a single method can't? (round-b rematch) | pending | — | `boundary_crossing/docs/research/labs_swarm.md` |
