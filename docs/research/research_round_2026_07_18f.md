...
**Status:** PARTIALLY LANDED — AP4 is gate-ready within the declared local Linux/process threat model; vDSO/physical timing stays explicit residual. AP5 is ready to replay AM2 through the attacked boundary; AP6 remains gated on AP5.
