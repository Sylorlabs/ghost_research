...
pub fn main() !void {
    ...
    var csv_path: []const u8 = "results/program_synthesis_inventor.csv";
    ...
    try stdout.print("=== PROGRAM SYNTHESIS INVENTOR ===\n", .{});
