...
- **Status:** AS1 local and AS2 cached public-web adapters are gate-ready; AS3 is a 12.5-second, 96-artifact/192-episode bounded scheduler positive; AS4 is a 4/4 opaque structural-process positive through a separate child; AS5 is a valid negative. AS6 is the remaining reduction audit.
...
- **AS4 result:** Separate opaque-frame child reaches 4/4 primary and 4/4 changed-encoding structural predictions over fixed 1/1, broad 2/3, random 0/2, replay 0/0, shuffled 2/0. This is no semantic reading or bug finding.
