...
- **LLM trace audit:** Live read-only subagent audit of ten tool/claim traces asks whether an apparently correct scalar was causally measured or merely guessed. It may recommend evidence gates but cannot score tasks.
