...
const mmm = @import("domain_meta_meta_meta_engine_opset");
const mm = @import("domain_meta_meta_engine_opset");
const tier0 = @import("domain_meta_engine_opset");
const mixer = @import("domain_opset");
